...
const Access = () => {
  return (
    ...
    >
      ...
      <p className="text-[#4D4D4D] font-urbanist text-[16px] md:text-[20px] md:leading-[28px] max-w-[100%] max-md:px-4 md:max-w-[63%] text-center mx-auto mb-[28px]">
      ...
      <div className="md:mt-[65px] mt-[45px] flex items-center justify-center flex-wrap gap-[20px]">
