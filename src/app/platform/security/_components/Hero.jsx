...
const Hero = () => {
  return (
    <>
      <section className=" px-8 pt-[152px] max-md:pt-[54px] w-full bg-blend-normal lg:max-h-[100vh]  max-md:min-h-[500px] max-lg:min-h-[706px]  max-md:px-5 max-md:max-w-full">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-center">
          <section className="flex flex-col w-full text-center lg:text-left">
            ...
            <h3 className="bg-clip-text gradient_heading w-full max-md:text-4xl font-sora font-bold text-[38px] md:text-[70px] leading-[70px] mb-[20px]">
              Data Security
            </h3>
            <p className=" font-urbanist md:mt-6 text-[14px] md:text-[18px] leading-[26px] text-[#EAEAEA] max-md:max-w-full mb-40 max-lg:text-center">
              Automated privacy-aware data security with 360 visibility and
              control of sensitive
              <br /> information across SaaS, Cloud & On-prem applications.
            </p>
          </section>
          <section className="w-[354px] md:min-w-[632px] mt-[-150px] md:mt-[-200px] md:mr-[-100px]">
            <Image
              loading="lazy"
              src="/images/platform/security2.png"
              alt=""
              width={632}
              height={389}
            />
