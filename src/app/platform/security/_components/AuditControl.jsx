...
const ContentSection = ({ content }) => (
  <div className="mt-6 w-fulls relative h-full rounded-2xl text-xl md:text-4xl font-bold text-white bg-white ">
    <div className="overflow-hidden lg:py-12 lg:pl-12 md:p-10 max-w-full bg-white rounded-xl shadow-[0px_12px_80px_rgba(50,50,50,0.08)] w-full max-md:pl-5 mt-14 mx-auto">
...
const AuditControl = ({ name, setCurrentSection, sectionRefs }) => {
