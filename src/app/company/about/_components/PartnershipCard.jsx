    ...
    <section className="relative bg-[#F5F8FF] w-fit mx-[16px] lg:mx-0  sm:mx-auto  sm:w-full  mt-[131px] max-md:mt-[70px]  rounded-2xl xl:pr-[98px] pr-[11px] xl:pt-[58px] pt-[45px] xl:pl-[58px] pl-[15px] xl:pb-[64px] pb-[168px] flex xl:flex-row flex-col justify-between max-md:justify-normal max-md:h-[534px] max-md:overflow-hidden md:bg-[url('/images/company/partnershipCardBg.png')] max-md:bg-[url('/images/hero/Mobile_banner.webp')] bg-center max-md:bg-[center_top] bg-cover  bg-no-repeat">
      <div className=" w-full xl:text-left text-center ">
        <h1 className="gradient_heading text-[28px] md:text-[32px] leading-[40px] font-sora font-semibold mb-[16px]">
          Partnership With LightBeam.ai
        </h1>
        <p className="text-[#D9D9D9] font-poppins para3B">
          Join us on a transformative journey, unlocking opportunities, <br />
          fostering innovation, and building lasting relationships as valued{" "}
          <br />
