...
const Content = () => {
  return (
    <div className="py-[100px]">
      <div className="mb-6">
        <p className="mb-6 text-[16px] font-urbanist font-normal">
      ...
      <div className="mb-6">
        <h2 className="mb-4 text-[20px] lg:text-[40px] font-sora font-semibold">
          Interpretation and Definitions
        </h2>
        <section className="mb-6">
          <h4 className="mb-4 text-[20px]  font-sora font-semibold">
            Interpretation
          </h4>
          <p className=" text-[16px] font-urbanist font-normal">
        ...
        <section className="mb-6">
          ...
          <p className=" text-[16px] font-urbanist font-normal">
            ...
            downloaded by You on any electronic device, named LightBeam
            Application
          </p>
          <p className=" text-[16px] font-urbanist font-normal">
            ...
            this Agreement) refers to LightBeam.ai, Inc., 460 California Avenue,
            Suite 205, Palo Alto, CA 94301; and all its affiliates. Content
            ...
            You, regardless of the form of that content. Device means any device
            that can access the Service such as a computer, a cellphone or a
            digital tablet. Feedback means feedback, innovations or suggestions
            sent by You regarding the attributes, performance or features of our
            Service. Free Trial refers to a limited period of time that may be
            free when purchasing a Subscription. Promotions refer to contests,
            sweepstakes or other promotions offered through the Service. Service
            ...
            subscription basis by the Company to You. Terms and Conditions (also
            ...
            use of the Service. Third-party Service means any services or
            ...
            by the Service. Website refers to LightBeam Site, accessible from
            www.lightbeam.ai You means the individual accessing or using the
      ...
      <div className="mb-6">
        ...
        <p className=" text-[16px] font-urbanist font-normal">
          ...
          https://www.lightbeam.ai/privacypolicy, carefully before using Our
          Service.
        </p>
      </div>
      <div className="mb-6">
        ...
        <section className="mb-6">
          ...
          <p className=" text-[16px] font-urbanist font-normal">
            ...
            periodic basis (such as daily, weekly, monthly, annually) or for a
            custom term, depending on the type of Subscription plan you select
            when purchasing the Subscription. At the end of each period, Your
            Subscription will end unless a new order form or subscription is
        ...
        <section className="mb-6">
          ...
          <p className="mb-6 text-[16px] font-urbanist font-normal">
            You may cancel Your current Subscription by contacting the Company.
        ...
        <section className="mb-6">
          <h4 className="mb-4 text-[20px]  font-sora font-semibold">Billing</h4>
          <p className="mb-6 text-[16px] font-urbanist font-normal">
            ...
            number, and a valid payment method information. The Company will
        ...
        <section className="mb-6">
          ...
          <p className="mb-6 text-[16px] font-urbanist font-normal">
            The Company, in its sole discretion, may modify the Subscription
            fees by providing 30 days written notice. Any Subscription fee
            change will become effective at the end of the then- current
            Subscription period. The Company will provide You with reasonable
            prior notice (no less than 30 days) of any change in Subscription
            fees to give You an opportunity to terminate Your Subscription
            before such change becomes effective.
          </p>
        </section>
        <section className="mb-6">
          <h4 className="mb-4 text-[20px]  font-sora font-semibold">Refunds</h4>
          <p className="mb-6 text-[16px] font-urbanist font-normal">
        ...
        <section className="mb-6">
          ...
          <p className="mb-6 text-[16px] font-urbanist font-normal">
            ...
            Free Trial for a limited period of time. You may be required to
            enter Your billing information in order to sign up for the Free
            Trial. If You do enter Your billing information when signing up for
            a Free Trial, You will not be charged by the Company until the Free
            ...
            have selected. At any time and without notice, the Company reserves
      ...
      <div className="mb-6">
        <h2 className="mb-0 text-[20px] lg:text-[40px] font-sora font-semibold">
          Your Right to Post Content
        </h2>
        <p className=" text-[16px] font-urbanist font-normal">
          Our Service may allow You to post Content on our website. You are
          responsible for the Content that You post to the Service, including
          its legality, reliability, and appropriateness. By posting Content to
          the Service, You grant Us the right and license to use, modify,
        ...
        <section className="mb-6">
          <h4 className="mb-2 mt-8 text-[20px]  font-sora font-semibold">
          ...
          <ul className="ml-7 my-6">
            <li className="list-disc font-urbanist">
        ...
        <section className="mb-6">
          <h2 className="mb-6 text-[20px] lg:text-[40px] font-sora font-semibold">
            Copyright Policy
          </h2>
          <h4 className="mb-2 mt-8 text-[20px]  font-sora font-semibold">
          ...
          <p className=" text-[16px] font-urbanist font-normal">
            ...
            attention of our copyright agent via email at info@lightbeam.ai and
            include in Your notice a detailed description of the alleged
            infringement. You may be held accountable for damages (including
            costs and attorneys&apos; fees) for misrepresenting that any Content
        ...
        <section className="mb-6">
          ...
          <p className=" text-[16px] font-urbanist font-normal">
            You can contact our copyright agent via email at info@lightbeam.ai.
      ...
      <div className="mb-6">
        <h2 className="mb-8 text-[20px] lg:text-[40px] font-sora font-semibold">
        ...
        <p className="mb-6 text-[16px] font-urbanist font-normal">
          ...
          withheld. The Company shall hold you harmless from liability to third
          ...
          secret, provided the Company is promptly notified of any and all
          threats, claims and proceedings related thereto and given reasonable
          assistance and the opportunity to assume sole control over defense and
          settlement; the Company will not be responsible for any settlement it
          does not approve in writing. The foregoing obligations do not apply
          with respect to portions or components of the Service (i) not supplied
          by the Company, (ii) that are modified after delivery by the Company,
          (iii) combined with other products, processes or materials where the
          alleged infringement relates to such combination, (iv) where you
          continue the allegedly infringing activity after being notified
          thereof or after being informed of modifications that would have
          avoided the alleged infringement, or (v) where your use of the Service
          ...
          jurisdiction to be or are believed by the Company to be infringing,
          the Company may, at its option and expense (a) replace or modify the
          ...
          (b) obtain for you a license to continue using the Service, or (c) if
          neither of the foregoing is commercially practicable, terminate this
          Agreement and your rights hereunder and provide you with a refund of
      ...
      <div className="mb-6">
        ...
        <p className="mb-6 text-[16px] font-urbanist font-normal">
          ...
          restriction as long as it is fully anonymised and aggregated.
        </p>
      </div>
      <div className="mb-6">
        <h2 className="mb-8 text-[20px] lg:text-[40px] font-sora font-semibold">
        ...
        <p className="mb-6 text-[16px] font-urbanist font-normal">
          Our Service may contain links to unaffiliated third-party web sites or
          services that are not owned or controlled by the Company. The Company
      ...
      <div className="mb-6">
        ...
        <p className="mb-6 text-[16px] font-urbanist font-normal">
          ...
          notice or liability, for reason , including without limitation if You
          breach these Terms and Conditions. Upon termination, Your right to use
      ...
      <div className="mb-6">
        ...
        <p className="mb-6 text-[16px] font-urbanist font-normal">
          Notwithstanding any damages that You might incur, except for
          Company&apos;s breach of applicable laws and regulations in providing
          this Service, the entire liability of the Company and any of its
          ...
          applicable law, in no event shall either Party or its suppliers be
          ...
          which means that some of the above limitations may not apply. In these
      ...
      <div className="mb-6">
        ...
        <p className="mb-6 text-[16px] font-urbanist font-normal">
          ...
          arbitration will take place in Santa Clara, California. Except as
          ...
          and federal courts located in Santa Clara, California, and the Parties
      ...
      <div className="mb-6">
        ...
        <h4 className="mb-0 text-[20px]  font-sora font-semibold">
          Severability
        </h4>
        <p className="mb-8 text-[16px] font-urbanist font-normal">
        ...
        <h4 className="mb-0 text-[20px]  font-sora font-semibold">Waiver</h4>
        <p className="mb-8 text-[16px] font-urbanist font-normal">
      ...
      <div className="mb-6">
        ...
        <ul className="ml-7 mb-6">
          <li className="list-disc font-urbanist">
            By email: info@lightbeam.ai
          </li>
        </ul>
      </div>
    </div>
