...
const BlogCard: React.FC<BlogCardProps> = ({
  ...
  return (
    <div className="flex mb-[136px] overflow-hidden flex-col flex-1 shrink self-stretch pb-6 my-auto bg-white rounded-2xl basis-0 min-w-[240px]">
...
const TrendingBlogsSection: React.FC = () => {
  ...
  return (
    <section className="flex flex-col items-center self-center pt-[132px] pb-2  w-full px-4 sm:px-[80px] m-auto max-md:pt-10 max-md:pb-[0px] max-md:max-w-full bg-[#F5F8FF] sm:bg-center max-sm:bg-custom-110">
