...
const contentDetails = [
  { title: "Data Subject Rights", value: "data-subject-rights" },
...
const PrivacyTab = ({ sectionData, imageData = {} }) => {
  ...
  useEffect(() => {
    const boxes = gsap.utils.toArray(".privacy_tab");
  ...
  function handleAnimationChange(newTabIndex) {
    if (tlRef.current) {
      const totalBoxes = gsap.utils.toArray(".privacy_tab").length - 1;
  ...
  return (
    <section
      className="flex overflow-hidden flex-col items-center px-20 lg:pt-24 md:pb-24 w-full bg-[#F5F8FF] max-md:px-5 max-md:mt-10 max-md:max-w-full"
      id="Privacy"
      ref={sectionRef}
    >
      <div className="self-stretch max-md:max-w-full">
        <div className="flex justify-center gap-5 max-md:flex-col">
          ...
          >
            <img
              loading="lazy"
              src={"/images/platform/privacy_left1.svg"}
              alt=""
          ...
          <div className="flex flex-col ml-5 w-[68%] max-md:ml-0 max-md:w-full">
            <div className="flex flex-col grow items-center mt-6 text-xl font-semibold text-center max-md:mt-10 max-md:max-w-full">
              <h2 className="lg:text-5xl font-sora text-black capitalize max-lg:text-4xl">
                {/* Privacy */}
              ...
              <Link
                href={sectionData[0]?.cta[0]?.url || "/platform/privacy-center"}
              >
                <HoverBorderGradientDemo
                  content={sectionData[0]?.cta[0]?.text}
                  // className="blue_btn h-auto"
                />
              </Link>
            </div>
          </div>
          ...
          >
            <img
              loading="lazy"
              src={"/images/platform/privacy_right1.svg"}
              alt=""
      ...
      <TabsDemo
        tabClass="max-md:mb-6"
        tabs={securityTabs}
        activeTab={cardsActive}
        animateClass={"privacy_tab"}
