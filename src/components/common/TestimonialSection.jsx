...
function TestimonialSection({ sectionData }) {
  const bg_img =
    sectionData?.images?.data && sectionData?.images?.data[0]?.attributes?.url;
  return (
    <section
      // style={{ backgroundPositionY: `${value}`, paddingTop: `${pt}` }}
      className=" flex overflow-hidden relative flex-col self-stretch mt-0 w-full max-md:max-w-full bg-[url('/images/home/Quote_bg.png')]  bg-center bg-cover md:bg-cover bg-no-repeat  lg:pt-20"
          ...
          <div className="flex relative flex-wrap gap-5 justify-between mb-0 w-full max-w-[1175px] max-md:mb-2.5 max-md:max-w-full ">
            <div className="flex  relative flex-col   rounded-[347px] max-md:max-w-full">
              ...
              <div className="relative">
                <div className="absolute top-4 left-[-10px] md:left-[-100px] md:top-[50px] rotate-180">
                  <Image
                    loading="lazy"
                ...
                <div className="absolute  right-0 md:right-[-100px] md:bottom-[0px] ">
                  <Image
                    loading="lazy"
                    src="/images/common/quotes.png"
                    height={50}
