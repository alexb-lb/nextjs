...
const Jobs = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F5F8FF] p-4 md:p-8">
      <div
        className="w-[100%] h-[60px] my-10 flex justify-center items-center"
        id="careers"
      >
      ...
      <div className="max-w-[90%] mx-auto  md:p-6">
        <h1 className="sm:text-[36px] text-[18px] flex gap-4 leading-[45px] font-semibold font-sora mb-5 sm:mb-8">
          ...
          <span className="max-md:text-[18px]">Engineer</span>
        </h1>
            ...
            .map((job, index) => (
              ...
              >
                <div className="flex justify-between items-center  sm:h-[150px] h-[70px] ">
                  <h2 className="text-[14px]  max-md:leading-[16px] md:text-[30px] font-semibold font-urbanist leading-9 w-[50%] text-[#232323]">
                    {job.title}
                  </h2>
      ...
      <div className="max-w-[90%] mx-auto  max-lg:mt-[40px] md:p-6">
        <h2 className="sm:text-[36px] text-[18px] flex gap-4 leading-[45px] font-semibold font-sora mb-5 sm:mb-8">
          <span>
            <svg
              width="40"
              height="40"
          ...
          <span className="max-md:text-[18px]">Management</span>
        </h2>

        <div className="space-y-4">
          {jobsproduct
            .filter((item, ind) =>
              viewAll ? ind < jobsproduct.length : ind < 3
            )
            .map((job, index) => (
              <div
                key={index}
              ...
              >
                <div className="flex justify-between items-center  sm:h-[150px] h-[70px] ">
                  ...
                  <p className="text-[12px] max-md:leading-[14px] md:text-[26px] font-normal font-urbanist leading-8 text-[#232323] w-[50%] md:w-[20%]">
                    Location - {job.location}
                  </p>
